(function () {
  ...
  function injectStyles() {
    ...
    var css = ""
      ...
      + "border-bottom:1px solid rgba(15,15,20,.08);background:#fff;position:relative;z-index:8;}"
      ...
      + "transition:background-color .3s ease,color .3s ease,transform .16s ease;}"
