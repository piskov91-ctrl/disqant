(function () {
  ...
  function injectStyles() {
    ...
    var css = ""
      ...
      + "-webkit-font-smoothing:antialiased;font-size:20px;line-height:1;}"
      ...
      + "overscroll-behavior:contain;touch-action:pan-y;background:#2c241f;}"
      + ".dq-stage{position:relative;width:100%;height:min(72vh,560px);"
      + "border-radius:18px;border:1px solid rgba(198,167,125,.2);"
      + "background:linear-gradient(180deg,#1a1612,#141210);"
      + "box-shadow:inset 0 1px 0 rgba(198,167,125,.08);overflow:hidden;}"
      + ".dq-stage img{width:100%;height:100%;display:block;background:#0f0f14;"
      + "object-fit:contain;object-position:center center;}"
      + ".dq-empty{height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;"
      + "color:rgba(245,237,228,.65);text-align:center;padding:18px;}"
      ...
      + "flex-direction:column;gap:10px;z-index:4;background:rgba(26,22,18,.82);backdrop-filter:blur(8px);}"
      ...
      + ".dq-processing-text{font:900 13px/1.25 system-ui,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#f5ede4;"
      ...
      + "border-radius:999px;background:rgba(245,237,228,.12);overflow:hidden;display:none;}"
      ...
      + "padding:12px 12px;border-radius:16px;border:1px solid rgba(198,167,125,.28);background:#1a1612;color:#f5ede4;"
      ...
      + ".dq-primary{appearance:none;border:0;cursor:pointer;border-radius:10px;padding:14px 28px;"
      + "background:#1a1612;color:#f5ede4;border:1px solid rgba(198,167,125,.28);"
      + "font:600 16px/1.25 system-ui,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;"
      + "letter-spacing:.5px;box-shadow:0 8px 22px rgba(0,0,0,.22);"
      + "transition:background-color .3s ease,color .3s ease,transform .16s ease,border-color .16s ease;}"
      ...
      // Save button
      + ".dq-save{appearance:none;border:1px solid rgba(198,167,125,.28);background:#1a1612;color:#f5ede4;"
      ...
      + "padding-bottom:max(12px, env(safe-area-inset-bottom, 0px));border-top:1px solid rgba(198,167,125,.18);"
      + "display:flex;align-items:center;justify-content:flex-start;background:#2c241f;}"
