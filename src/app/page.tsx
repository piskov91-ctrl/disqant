      ...
      <main className="pt-16">
        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-6xl px-6 py-20 md:py-24 lg:py-28">
            <div className="grid min-h-[min(70vh,640px)] items-center gap-16 md:grid-cols-[0.9fr_1.32fr] md:items-center md:gap-20 lg:gap-24">
              ...
              <div className="relative flex w-full min-w-0 justify-center pl-2 md:justify-end md:pl-4 lg:pl-6">
                <video
