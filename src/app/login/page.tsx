    ...
    <>
      ...
      <main className="pt-[var(--site-header-height)]">
        <div className="mx-auto max-w-md px-6 py-16 md:py-24">
          <h1 className="on-photo-heading text-3xl font-semibold tracking-tight text-zinc-50">Log In</h1>
          <p className="on-photo-body mt-2 text-sm text-zinc-400">Access your dashboard, API key, and try-on statistics.</p>
          <LoginForm />
