...
async function compressImageToMax1000px(file: File) {
  // Downscale to max 1000px on the longest side and encode as JPEG for consistent size.
  // If anything fails (unsupported format), fall back to original.
  try {
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:gap-12">
          <div className="lg:w-[420px]">
            ...
            <p className="mt-4 text-zinc-400">
              Upload a person photo and a garment image. The try-on runs securely server-side using
              your <span className="text-zinc-200">FASHN_API_KEY</span>.
            </p>
