        ...
        {tab === "getCode" ? (
          <div className="mt-10 max-w-3xl space-y-10">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-zinc-500">Follow these steps in order. Each step has a picture placeholder for a future guide.</p>
              ...
              <ol className="mt-8 space-y-10">
                <li className="flex gap-5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-4 flex aspect-video w-full max-w-xl items-center justify-center rounded-xl border border-dashed border-white/20 bg-zinc-950/50 text-center text-sm text-zinc-500">
                      Screenshot placeholder — copying the embed code
                    </div>
                  </div>
                </li>
                ...
                <li className="flex gap-5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-4 flex aspect-video w-full max-w-xl items-center justify-center rounded-xl border border-dashed border-white/20 bg-zinc-950/50 text-center text-sm text-zinc-500">
                      Screenshot placeholder — opening the site editor
                    </div>
                  </div>
                </li>
                ...
                <li className="flex gap-5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-4 flex aspect-video w-full max-w-xl items-center justify-center rounded-xl border border-dashed border-white/20 bg-zinc-950/50 text-center text-sm text-zinc-500">
                      Screenshot placeholder — pasting before &lt;/body&gt;
                    </div>
                  </div>
                </li>
                ...
                <li className="flex gap-5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-4 flex aspect-video w-full max-w-xl items-center justify-center rounded-xl border border-dashed border-white/20 bg-zinc-950/50 text-center text-sm text-zinc-500">
                      Screenshot placeholder — save and publish
                    </div>
                  </div>
                </li>
              </ol>
