...
/** Privacy notice above the Wear Me stage (matches `public/widget.js`). */
...
export const DEMO_WEAR_MODAL_CSS =
  ...
  ".dq-backdrop{position:fixed;top:var(--site-header-height,0px);left:0;right:0;bottom:0;z-index:50;background:rgba(15,23,42,.45);display:flex;align-items:center;justify-content:center;padding:8px;opacity:0;transition:opacity .18s ease;}" +
