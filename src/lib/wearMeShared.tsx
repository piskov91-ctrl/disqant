...
export function resetWearMeStageImageFit(img: HTMLImageElement | null | undefined) {
  if (!img) return;
...
export const WEAR_ME_FULLSCREEN_CSS =
  ".dq-fs{position:absolute;top:12px;right:12px;z-index:8;width:40px;height:40px;padding:0;border-radius:999px;display:inline-flex;align-items:center;justify-content:center;cursor:pointer;border:1px solid rgba(255,255,255,.4);background:linear-gradient(135deg,#c6a77d 0%,#e2cfb4 50%,#c6a77d 100%);color:#2c241f;box-shadow:0 6px 18px rgba(0,0,0,.3),inset 0 1px 1px rgba(255,255,255,.5);transition:transform .16s ease,filter .16s ease;-webkit-tap-highlight-color:transparent;}" +
...
export function WearMeResultFullscreen({
  ...
  active: boolean;
  stageImageRef?: RefObject<HTMLImageElement | null>;
}) {
  ...
  const closeFullscreen = useCallback(() => {
    ...
    requestAnimationFrame(() => {
      resetWearMeStageImageFit(stageImageRef?.current ?? null);
    });
  }, [stageImageRef]);
...
export const DEMO_WEAR_MODAL_CSS =
  ...
  ".dq-backdrop{position:fixed;inset:0;z-index:50;background:rgba(15,23,42,.45);display:flex;align-items:center;justify-content:center;padding:8px;opacity:0;transition:opacity .18s ease;}" +
  ".dq-backdrop.dq-open{opacity:1;}" +
  ".dq-backdrop.dq-dismiss-locked{cursor:default;-webkit-user-select:none;user-select:none;}" +
  ".dq-modal{position:relative;width:min(720px,100%);min-height:0;height:min(calc(100dvh - var(--site-header-height,0px) - 16px),calc(100vh - var(--site-header-height,0px) - 16px));max-height:min(calc(100dvh - var(--site-header-height,0px) - 16px),calc(100vh - var(--site-header-height,0px) - 16px));background:#2c241f;border:1px solid rgba(198,167,125,.22);border-radius:20px;overflow:hidden;box-shadow:0 30px 80px rgba(0,0,0,.45);display:flex;flex-direction:column;color:#f5ede4;transform:translateY(10px) scale(.985);opacity:0;transition:transform .18s ease, opacity .18s ease;}" +
  ...
  ".dq-empty img{width:100%;height:100%;object-fit:contain;transform:scaleY(1.2) !important;display:block;}" +
  ...
  ".dq-wow{flex-shrink:0;text-align:center;color:#c6a77d;font-family:Georgia,ui-serif,serif;font-weight:700;font-size:16px;letter-spacing:1px;padding:2px 8px;animation:dq-wow-in .6s ease both;}" +
  ...
  ".dq-stage-toast{position:absolute;top:max(8px,env(safe-area-inset-top,0px));left:8px;right:8px;z-index:9;margin:0;pointer-events:none;}" +
  ...
  ".dq-modal-cta{flex-shrink:0;padding:0 4px 4px;}" +
  ...
  "@media (min-width:521px){.dq-backdrop{top:var(--site-header-height,0px);}.dq-modal{height:min(calc(100dvh - var(--site-header-height,0px) - 16px),calc(100vh - var(--site-header-height,0px) - 16px));max-height:min(calc(100dvh - var(--site-header-height,0px) - 16px),calc(100vh - var(--site-header-height,0px) - 16px));}.dq-modal-foot{padding:20px 16px 24px;}.dq-modal-foot .dq-x{min-width:88px;min-height:58px;font-size:28px;line-height:1;box-shadow:0 14px 32px rgba(0,0,0,.2);}.dq-modal-foot .dq-x-icon{width:30px;height:30px;}}" +
  "@media (max-width:520px){.dq-backdrop{padding:8px;align-items:center;}.dq-head{padding-right:max(56px,calc(60px + env(safe-area-inset-right, 0px)));}.dq-modal-foot{position:absolute;top:max(10px, env(safe-area-inset-top, 0px));right:max(10px, env(safe-area-inset-right, 0px));left:auto;bottom:auto;z-index:50;border:0;padding:0;background:transparent;}.dq-x{min-width:54px;min-height:54px;font-size:22px;line-height:1}.dq-x-icon{width:26px;height:26px}}" +
  "@media (max-width:420px){.dq-choice{min-width:100%}.dq-stage-actions .dq-choice{min-width:120px;max-width:48%;}.dq-stage-actions .dq-wear-me{max-width:100%;}}" +
