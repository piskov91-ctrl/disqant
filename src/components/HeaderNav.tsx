    ...
    <div className="flex min-w-0 items-center justify-end gap-2 sm:gap-3">
      ...
      {open ? (
        <div className="fixed inset-0 z-[70] md:hidden">
          ...
          <div
            id={menuId}
            className="absolute right-0 top-[150px] w-[min(100vw,420px)] max-h-[calc(100dvh-150px)] overflow-y-auto border-l border-b border-surface-border bg-white/95 p-4 shadow-2xl shadow-zinc-200/40 backdrop-blur-xl"
            role="dialog"
            aria-modal="true"
